declare module 'mongoose' {
  ...
  export function model<T extends { [key: string]: any; }>(name: string, schema?: Schema<any>, collection?: string, skipInit?: boolean): Model<T>;
  export function model<T extends { [key: string]: any; }, U extends Model<T, TQueryHelpers, any>, TQueryHelpers = {}>(
    name: string,
  ...
  class Connection extends events.EventEmitter {
     ...
     */
    createCollection<T extends { [key: string]: any; } = any>(name: string, options?: mongodb.CollectionCreateOptions): Promise<mongodb.Collection<T>>;
    createCollection<T extends { [key: string]: any; } = any>(name: string, cb: Callback<mongodb.Collection<T>>): void;
    createCollection<T extends { [key: string]: any; } = any>(name: string, options: mongodb.CollectionCreateOptions, cb?: Callback<mongodb.Collection>): Promise<mongodb.Collection<T>>;
    ...
    model<T extends { [key: string]: any; }>(name: string, schema?: Schema<any>, collection?: string): Model<T>;
    model<T extends { [key: string]: any; }, U extends Model<T, TQueryHelpers, any>, TQueryHelpers = {}>(
      name: string,
      schema?: Schema<T, U, TQueryHelpers>,
      collection?: string,
      skipInit?: boolean
  ...
  interface AcceptsDiscriminator {
    ...
    discriminator<D extends { [key: string]: any; }>(name: string | number, schema: Schema, value?: string | number | ObjectId): Model<D>;
    discriminator<T extends { [key: string]: any; }, U>(name: string | number, schema: Schema<T, U>, value?: string | number | ObjectId): U;
  }
  ...
  interface Model<T extends { [key: string]: any; }, TQueryHelpers = {}, TMethods = {}> extends NodeJS.EventEmitter, AcceptsDiscriminator {
  ...
  class Schema<DocType extends { [key: string]: any; } = Document, M = Model<DocType, any, any>, SchemaDefinitionType = undefined, TInstanceMethods = {}> extends events.EventEmitter {
    /**
     * Create a new schema
     */
  ...
  namespace Schema {
    namespace Types {
      class Array extends SchemaType implements AcceptsDiscriminator {
        ...
        discriminator<D extends { [key: string]: any; }>(name: string | number, schema: Schema, value?: string): Model<D>;
        discriminator<T extends { [key: string]: any; }, U>(name: string | number, schema: Schema<T, U>, value?: string): U;
